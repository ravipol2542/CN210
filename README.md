...
<br>คำสั่ง branch of equal คือ การกระโดดแบบมีเงื่อนไข กระโดดเมื่อrs-rt=0 หรือ rs มีค่าเท่ากับrt

<br>beq $rs $rt offset
<br>ขั้นตอนที่1 การเอาคำสั่งจากmemory ไปยัง instruction register และในขณะเดียวกัน PC = PC+4
<br>ขั้นตอนที่2 การถอดรหัสคำสั่ง เอาค่าในรีจิสเตอร์ของrs, rt ไปพักไว้ใน A, B
<br>ขั้นตอนที่3 นำค่าที่พักในA,B คำนวณในALUว่า rs-rt=0ไหม ถ้าเท่ากันจะกระโดด ซึ่งกระโดดไปที่ PC=ALUOut
...
<br>![immage](125.gif)
<br>การทำงานของ Pipelining โดยเมื่อเเราเอากองผ้า A เข้าไปใส่ที่เครื่องอบเเห้งเเล้วเครื่องซักผ้าตัวเเรกจะว่าง ดังนั้นเราจะเอากองผ้า B ใส่ลงในเครื่องซักผ้าตัวเเรกทำอย่างนี้ต่อไปเรื่อยๆตามขั้นตอนจะเห็นถึงความเเตกต่างของเวลาการทำงานเเบบปกติจะใช้เวลานานกว่าการทำงานของ Pipelining อย่างมาก
